...
class FrameApp(Frame):
    def __init__(self,master):
        ...
        self.b1 = Button(self, text="Воспроизвести", command=self.play_music, width=20)
        self.b1.grid(row=1, column=0)

        self.b2 = Button(self, text="Предыдущий", command=self.previous_song,
                         width=20)
        self.b2.grid(row=2, column=0)

        self.b3 = Button(self, text="Пауза", command=self.toggle, width=20)
        self.b3.grid(row=3, column=0)

        self.b4 = Button(self, text="Следующий", command=self.next_song, width=20)
        self.b4.grid(row=4, column=0)

        self.b5 = Button(self, text="Добавить в список", command=self.add_to_list,
                         width=20)
    ...
    def add_to_list(self):
        """
        Открывает окно для просмотра данных на диске и добавляет выбранные песни в список воспроизведения.
        :return: None
        """
        directory = askopenfilenames()
        # добавляет каталог песен на диске в список воспроизведения в памяти
        ...
        for key, item in enumerate(self.playlist):
            # добавляет песню в текстовое поле
            song = EasyID3(item)
    ...
    def song_data(self):
        """
        Делает строку данных текущей воспроизводимой песни поверх текстового поля
    ...
    def play_music(self):
        """
        Загружает текущую песню, воспроизводит ее, устанавливает событие по окончании песни
        :return: None
        """
    ...
    def check_music(self):
        """
        Прослушивает событие END_MUSIC и запускает воспроизведение следующей песни, если текущая
         песня закончилась
        :return: None
        """
    ...
    def get_next_song(self):
        """
        Получает номер следующей песни в плейлисте
    ...
    def get_previous_song(self):
        """
        Получает номер предыдущей песни в плейлисте и возвращает его
    ...
    def previous_song(self):
        """
        Воспроизводит предыдущую песню
        :return:
        """
